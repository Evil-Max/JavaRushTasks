    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                result = String.format ("%tY%tm%td",date1,date1,date1).compareTo(String.format ("%tY%tm%td",date2,date2,date2));
                ...
                Double change1 = !stock1.containsKey("change") ? (last-open)   : ((double) stock1.get("change"));
                open = !stock2.containsKey("open") ? 0 : ((double) stock2.get("open"));
                last = !stock2.containsKey("last") ? 0 : ((double) stock2.get("last"));
                Double change2 = !stock2.containsKey("change") ? (last-open)   : ((double) stock2.get("change"));
                result = 0-change1.compareTo(change2);
                return result;
            }
        });
    }
